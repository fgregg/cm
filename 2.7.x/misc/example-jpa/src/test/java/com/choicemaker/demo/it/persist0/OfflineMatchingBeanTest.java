...
import static com.choicemaker.demo.it.persist0.BatchDeploymentUtils.EJB_MAVEN_COORDINATES;
import static com.choicemaker.demo.it.utils0.DeploymentUtils.PERSISTENCE_CONFIGURATION;
import static com.choicemaker.demo.it.utils0.DeploymentUtils.PROJECT_POM;
...
import com.choicemaker.demo.it.utils0.DeploymentUtils;
import com.choicemaker.demo.persist0.BatchJob;
import com.choicemaker.demo.persist0.BatchJobBean;
import com.choicemaker.demo.persist0.BatchJobStatus;
import com.choicemaker.demo.persist0.OfflineMatchingBean;

@RunWith(Arquillian.class)
public class OfflineMatchingBeanTest {
	...
	private static final Logger logger = Logger
			.getLogger(OfflineMatchingBeanTest.class.getName());

	@Deployment
	public static EnterpriseArchive createEarArchive() {
		List<Class<?>> testClasses = new ArrayList<>();
		testClasses.add(OfflineMatchingBeanTest.class);
	...
	@EJB
	protected OfflineMatchingController controller;
	...
	public void testPersistFindRemove() {
		...
		// Find the job
		OfflineMatchingBean batchJob2 = controller.find(job.getId());
	...
	public void testMerge() {
		...
		OfflineMatchingBean job = new OfflineMatchingBean(externalId);
		controller.save(job);
		assertTrue(job.getId() != 0);
		...
		job = null;
		OfflineMatchingBean batchJob2 = controller.find(id);
	...
	public void testFindAll() {
		...
		List<OfflineMatchingBean> jobs = controller.findAll();
		...
		// Remove the job
		for (long id : jobIds) {
			OfflineMatchingBean job = controller.find(id);
	...
	public void testType() {
		...
		OfflineMatchingBean job =
			new OfflineMatchingBean("EXT ID: " + new Date().toString());
		assertTrue(OfflineMatchingBean.TABLE_DISCRIMINATOR
				.equals(job.getType()));
	...
	public void testEqualsHashCode() {
		...
		OfflineMatchingBean job1 = new OfflineMatchingBean(exId, trID);
		OfflineMatchingBean job2 = new OfflineMatchingBean(exId, trID);
