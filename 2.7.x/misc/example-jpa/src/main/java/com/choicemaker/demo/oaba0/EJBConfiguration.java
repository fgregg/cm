...
//		QueueSession session = this.connection.createQueueSession(true, 0);
	...
	/** A convenience method that creates a new, persistent BatchJob record */
	public BatchJob createBatchJob(String externalId) throws RemoteException,
			CreateException, NamingException, SQLException {
		BatchJobBean retVal = new BatchJobBean(externalId);
		em.persist(retVal);
		return retVal;
	}

	public StatusLog createStatusLog(long id) throws RemoteException,
			CreateException, NamingException {
		StatusLogBean retVal = new StatusLogBean(id);
		em.persist(retVal);
		return retVal;
	}
...
//		BatchParametersBean retVal = new BatchParametersBean(id);
//		em.persist(retVal);
//		return retVal;
	}
	 ...
	 * @throws NamingException
	 */
	public BatchJob findBatchJobById(long id) throws RemoteException,
...
//		return retVal;
	...
	public BatchParameters findBatchParamsById(long id) throws RemoteException,
			FinderException, NamingException {
		throw new Error("not yet implemented");
...
//		TransitivityJobHome transJobHome =
//			(TransitivityJobHome) PortableRemoteObject.narrow(homeRef,
...
//		return retVal;
	...
	public StatusLog findStatusLogById(long id) throws RemoteException,
			FinderException, NamingException {
		throw new Error("not yet implemented");
...
//			this.batchJobHome =
//				(BatchJobHome) PortableRemoteObject.narrow(homeRef,
//						BatchJobHome.class);
//		}
...
//				(BatchParametersHome) PortableRemoteObject.narrow(homeRef,
...
//			this.statusLogHome =
//				(StatusLogHome) PortableRemoteObject.narrow(homeRef,
//						StatusLogHome.class);
//		}
//		return this.statusLogHome;
//	}

	public OabaEventLog getStatusLog(StartData data) throws RemoteException,
			FinderException, NamingException {
		throw new Error("not yet implemented");
...
//		return retVal;
	...
	public OabaEventLog getStatusLog(long jobID) throws RemoteException,
			FinderException, NamingException {
		throw new Error("not yet implemented");
...
//		return retVal;
	...
	public void createNewStatusLog(long id) throws RemoteException,
			CreateException, NamingException {
		throw new Error("not yet implemented");
