 ...
 *
 */
public class EmbeddedEclipseBean implements Serializable{

	private static final long serialVersionUID = 271L;

	private static Logger logger = Logger.getLogger(EmbeddedEclipseBean.class
			.getName());
	...
	public EmbeddedEclipseBean() {
		this(null);
	}

	public EmbeddedEclipseBean(String config) {
