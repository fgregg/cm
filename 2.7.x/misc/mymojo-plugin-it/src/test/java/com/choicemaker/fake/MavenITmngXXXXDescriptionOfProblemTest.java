    ...
    extends AbstractMavenIntegrationTestCase
{
        ...
        throws Exception
    {
        ...
        verifier.deleteArtifact( GROUPID, STEP001_ARTIFACT_ID, STEP001_VERSION, STEP001_PACKAGING );
        verifier.deleteArtifact( GROUPID, STEP002_ARTIFACT_ID, STEP002_VERSION, STEP002_PACKAGING );
         ...
         */
        verifier = new Verifier( new File( testDir.getAbsolutePath(), STEP001_WORKING_DIR ).getAbsolutePath() );
