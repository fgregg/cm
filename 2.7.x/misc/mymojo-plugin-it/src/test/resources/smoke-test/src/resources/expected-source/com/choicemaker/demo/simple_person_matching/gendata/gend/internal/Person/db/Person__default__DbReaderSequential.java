...
public final class Person__default__DbReaderSequential implements DbReaderSequential {
private static Logger logger = Logger.getLogger(com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person.db.Person__default__DbReaderSequential.class.getName());
...
return Person__default__DbReaderParallel.NO_CURSORS;
}
...
return Person__default__DbReaderParallel.masterId;
}
public String getMasterIdType() {
return Person__default__DbReaderParallel.masterIdType;
}
public DbView[] getViews() {
return Person__default__DbReaderParallel.views;
}
}
