...
import com.choicemaker.eclipse2.pd.InstallablePluginDiscovery;
...
public class EmbeddedPluginDiscoveryTest {
	...
	@BeforeClass
	public void configureEmbeddedPluginDiscovery() {
	 ...
	 * "com.choicemaker.eclipse2.embed.pd.EmbeddedPluginDiscovery.EmbeddedPluginDiscovery"
	 * }.
