 ...
 * ClueMaker compiler.
 *
 * @deprecated Use the CMCompiler class instead.
...
abstract class Compiler implements ICompiler {
	...
	static ClassLoader getJavacClassLoader() {
		String tools =
	...
	protected static Logger logger = Logger.getLogger(Compiler.class);

	protected static void usage() {
		System.out.println(
			MessageUtil.m.formatMessage(
				"compiler.comp.usage",
				"$Revision: 1.2 $, $Date: 2010/03/24 20:12:40 $"));
	}
