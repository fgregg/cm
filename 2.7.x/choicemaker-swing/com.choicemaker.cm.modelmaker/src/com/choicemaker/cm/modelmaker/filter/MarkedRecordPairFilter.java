...
public class MarkedRecordPairFilter implements PropertyChangeListener, Filter {
	private static Logger logger = Logger.getLogger(MarkedRecordPairFilter.class);
	private static MarkedRecordPairFilter instance = null;
	...
	public MarkedRecordPairFilter(ModelMaker parent) {
		this.parent = parent;
