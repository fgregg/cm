...
public class MatchDedupIT {
	...
	public static EnterpriseArchive createEarArchive() {
		Class<?>[] removedClasses = { UpdateStatus.class };
	...
	public void testPrequisites() {
		...
		assertTrue(matchDedupQueue != null);
	...
	public void testStartLinkage() {
		...
		OabaTestUtils.testFinalOabaProcessing(LOG_SOURCE, TEST, externalID, bp,
				oabaSettings, serverConfiguration, batchQuery, jobController,
