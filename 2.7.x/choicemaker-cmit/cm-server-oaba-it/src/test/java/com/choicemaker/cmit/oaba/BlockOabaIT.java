...
public class BlockOabaIT {
	 ...
	 * attach to the dedup and update queues for testing.
	 */
	@Deployment
	...
	public void testStartOABA(final String tag, final String externalId,
		...
		assertTrue(processingEntry.getCurrentProcessingEventId() == EVT_DONE_OVERSIZED_TRIMMING);
		...
		assertTrue(updateMessage.getPercentComplete() == PCT_DONE_OVERSIZED_TRIMMING);
