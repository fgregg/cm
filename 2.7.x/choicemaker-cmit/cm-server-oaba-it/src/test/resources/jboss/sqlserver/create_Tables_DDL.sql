...
CREATE TABLE CMT_DEFAULT_SETTINGS (
 ...
 PRIMARY KEY (DATABASE_CONFIG, BLOCKING_CONFIG, MODEL, TYPE)
);
...
CREATE TABLE CMT_OABA_BATCH_PARAMS (
 ...
 OPTLOCK integer DEFAULT 0,
 QUERY_RS_DBCONF VARCHAR(255) NULL,
 QUERY_RS_ID NUMERIC(19) NULL,
 QUERY_RS_DEDUPED BIT default 0 NULL,
 QUERY_RS_TYPE VARCHAR(255) NULL,
 Q2Q_BLOCKING VARCHAR(255) NULL,
 Q2R_BLOCKING VARCHAR(255) NULL,
 REF_RS_DBCONF VARCHAR(255) NULL,
 REF_RS_ID NUMERIC(19) NULL,
 REF_RS_TYPE VARCHAR(255) NULL,
...
CREATE TABLE CMT_NAMED_CONFIG (
 NC_ID NUMERIC(19) NOT NULL,
 LIMIT_BLOCKSET INTEGER NULL,
 LIMIT_SINGLESET INTEGER NULL,
 LIMIT_SINGLETABLE INTEGER NULL,
 BLOCKING_CONF VARCHAR(255) NULL,
 NC_NAME VARCHAR(255) NULL,
 DATA_SOURCE VARCHAR(255) NULL,
 HIGH_THRESHOLD FLOAT(16) NULL,
 CLASS VARCHAR(255) NULL,
 LOW_THRESHOLD FLOAT(16) NULL,
...
INSERT INTO CMT_SEQUENCE(SEQ_NAME, SEQ_COUNT) values ('BATCHPARAMS', 0);
...
INSERT INTO CMT_SEQUENCE(SEQ_NAME, SEQ_COUNT) values ('NAMED_CONFIG', 0);
