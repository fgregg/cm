...
public final class Person2SingleFileFlatFileReader implements FlatFileReader {
private static Logger logger = Logger.getLogger(com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person2.flatfile.Person2SingleFileFlatFileReader.class.getName());
private Tokenizer tokenizer;
private boolean tagged;
private boolean singleLine;
private static DerivedSource src = DerivedSource.valueOf("flatfile");
public Person2SingleFileFlatFileReader(Tokenizer tokenizer, boolean tagged, boolean singleLine) {
