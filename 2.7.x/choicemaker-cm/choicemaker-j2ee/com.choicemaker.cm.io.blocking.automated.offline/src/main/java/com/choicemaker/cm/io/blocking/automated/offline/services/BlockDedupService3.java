...
public class BlockDedupService3 {
	...
	private static final Logger log = Logger.getLogger(BlockDedupService3.class.getName());
...
//	private int maxBlockSize;
	...
	public BlockDedupService3 (BlockGroup bGroup, IBlockSinkSourceFactory bFactory,
		...
		IBlockSink bSink, int maxBlockSize, OabaProcessing status, int interval) {
...
*/
			...
			status.setCurrentProcessingEvent(OabaEvent.DEDUP_BLOCKS, Integer.toString(count) );
			count ++;
		...
		status.setCurrentProcessingEvent(OabaEvent.DONE_DEDUP_BLOCKS);
