...
public class RecValDBFactory implements IRecValSinkSourceFactory {
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getNextSink()
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getNextSource()
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getNumSink()
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getNumSource()
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#removeSink(com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSink)
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getSource(com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSink)
	 */
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSinkSourceFactory#getSink(com.choicemaker.cm.io.blocking.automated.offline.core.IRecValSource)
	 */
