...
//	private int maxBlockSize;
	 ...
	 */
	public BlockDedupService (BlockGroup bGroup, IBlockSink bSink, int maxBlockSize, OabaProcessing status) {
		this.bGroup = bGroup;
		this.bSink = bSink;
...
//				System.out.println (i + " Processing: " + source.getInfo() + " count: " + numBlocksIn);
				...
				if (MemoryEstimator.isFull(FULL) || (i == parts.length  - 1)) {
					...
					status.setCurrentProcessingEvent(OabaEvent.DEDUP_BLOCKS, Integer.toString(i) );
