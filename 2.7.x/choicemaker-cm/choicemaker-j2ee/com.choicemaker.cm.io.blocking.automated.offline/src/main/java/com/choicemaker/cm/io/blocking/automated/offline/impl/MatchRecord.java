 ...
 * This class is used internally only by MatchRecordSource to create
...
class MatchRecord implements Comparable<IMatchRecord>, IMatchRecord {
	...
	public boolean equals (IMatchRecord mr) {
		boolean ret = false;
		if (this.getRecordID1() == mr.getRecordID1() && this.getRecordID2() == mr.getRecordID2() &&
			this.getRecord2Source() == mr.getRecord2Source()) ret = true;
		return ret;
	}
	...
	public int compareTo(IMatchRecord mr) {
		int ret = 0;
		if (getRecordID1() < mr.getRecordID1()) ret = -1;
		else if (getRecordID1() > mr.getRecordID1()) ret = 1;
		else if (getRecordID1() == mr.getRecordID1()) {
			if (getRecordID2() < mr.getRecordID2()) ret = -1;
			else if (getRecordID2() > mr.getRecordID2()) ret = 1;
			else if (getRecordID2() == mr.getRecordID2()) ret = 0; 
		}
		return ret;
	}
	...
	public boolean equals (Object o) {
		...
		if (o.getClass() == MatchRecord.class) {
			...
			if ((getRecordID1() == p.getRecordID1()) && (getRecordID2() == p.getRecordID2())) ret = true;
		}
		return ret;
	}
