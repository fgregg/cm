...
/**
 * This object performs set find, set union, and set path compression using an int array
 * as base.
 * 
...
public class SetJoiner {
	...
	/**
	 * This is the initial value.  If rootArray[i] = DEFAULT, then i is not in any set.
	 */
	public static final int DEFAULT = -1;

	
	/** This constructor takes in the maximum size of the array of roots.  It can handle up to 
	 * maxSize integer elements.
	 * 
	 * @param maxSize - maximum number of integers to find and union.
	 */
	...
	public void union (int i, int j) {
		...
		if (rootArray[i] == DEFAULT) rootArray[i] = i;
		if (rootArray[j] == DEFAULT) rootArray[j] = j;
	...
	public int [] flatten () {
		...
		for (int i = 1; i < size; i++) {
			if (rootArray[i] != DEFAULT) rootArray[i] = rootArray[ rootArray[i] ];
		}
	 ...
	 * 
	 * @param i - the member for whom you are finding the root.
	 ...
	 * 
	 * @param i - the path starting from i for which you want to directly connect to root 
	 * @param root - the root value to which you want to set
	 */
