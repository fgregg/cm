...
/**
 * This is a sink of sinks.  It uses round robin method to distribute the ComparisonArrays
 * evenly across the sinks.
 * 
 * @author pcheung
 *
 */
public class ComparisonArrayGroupSink implements IComparisonArraySink {
	 ...
	 * @param num
	 */
	public ComparisonArrayGroupSink (ComparisonArraySinkSourceFactory factory, int num) 
	...
	/* (non-Javadoc)
	 * @see com.choicemaker.cm.io.blocking.automated.offline.core.IComparisonArraySink#writeComparisonArray(com.choicemaker.cm.io.blocking.automated.offline.core.ComparisonArray)
	 */
