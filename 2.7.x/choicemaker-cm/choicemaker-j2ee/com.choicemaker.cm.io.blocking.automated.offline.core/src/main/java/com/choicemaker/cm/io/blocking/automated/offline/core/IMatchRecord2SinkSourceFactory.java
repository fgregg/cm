...
public interface IMatchRecord2SinkSourceFactory<T extends Comparable<T>> {
	...
	public IMatchRecord2Source<T> getSource (IMatchRecord2Sink<T> sink) throws BlockingException;
	
	/** Creates an IMatchRecord2Sink for an existing IMatchRecord2Source. */
	public IMatchRecord2Sink<T> getSink (IMatchRecord2Source<T> source) throws BlockingException;
	...
	public void removeSource (IMatchRecord2Source<T> source) throws BlockingException;
	
	/** Moves source1 to source2. */
	public void move (IMatchRecord2Source<T> source1, IMatchRecord2Source<T> source2) throws BlockingException;

	/** Moves sink1 to sink2. */
	public void move (IMatchRecord2Sink<T> sink1, IMatchRecord2Sink<T> sink2) throws BlockingException;
