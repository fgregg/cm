...
public interface IRecordIDTranslator {
	...
	/**
	 * This method reverse translates a block source with internal id to a block
	 * sink with record ids.
	 */
	public void reverseTranslate(IBlockSource bSource, IBlockSink bSink)
