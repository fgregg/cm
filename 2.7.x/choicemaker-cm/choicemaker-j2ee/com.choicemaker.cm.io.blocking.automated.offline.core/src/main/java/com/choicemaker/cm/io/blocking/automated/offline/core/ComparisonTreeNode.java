 ...
 *
 */
public class ComparisonTreeNode<T extends Comparable<? super T>> implements
		Serializable {
	 ...
	 * children...)
	 */
	private static class LeafComparisonTreeNode<T extends Comparable<? super T>>
			extends ComparisonTreeNode<T> {

		private static final long serialVersionUID = 1L;
		private final int blockingSetId;

		public LeafComparisonTreeNode(T recordId, char type,
				int blockingSetId) {
			super(recordId, type);
