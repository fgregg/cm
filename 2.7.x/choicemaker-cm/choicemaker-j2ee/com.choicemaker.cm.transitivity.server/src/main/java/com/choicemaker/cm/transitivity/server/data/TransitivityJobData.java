 ...
 *
 */
public class TransitivityJobData implements Serializable {
	...
	// constructor
	public TransitivityJobData(long jobId) {
		this.jobID = jobId;
	}

	// copy constructor
	public TransitivityJobData(TransitivityJobData data) {
	...
	// create MatchWriterMessage from TransitivityJobData
	public TransitivityJobData(MatchWriterMessage data) {
		this.jobID = data.jobID;
		this.ind = data.ind;
		this.stageType = data.stageType;
		this.masterType = data.masterType;
