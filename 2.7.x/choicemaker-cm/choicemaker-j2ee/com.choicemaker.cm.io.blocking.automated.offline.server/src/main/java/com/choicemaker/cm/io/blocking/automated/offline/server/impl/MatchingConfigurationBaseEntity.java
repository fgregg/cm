...
public class MatchingConfigurationBaseEntity extends AbstractPersistentObject {
	...
	protected long matchingConfigurationId;
	
	protected /*final*/ String matchingConfigurationType;
	
	protected /*final*/ String probablityModelName;
	...
	protected /*final*/ boolean isQueryRsDeduplicated;

	protected /*final*/ String queryRsDatabaseConfiguration;

	protected /*final*/ String referenceRsDatabaseConfiguration;

	protected /*final*/ boolean queryToQueryBlockingConfiguration;

	protected /*final*/ boolean queryToReferenceBlockingConfiguration;

	/** Required by JPA; do not invoke directly */
	public MatchingConfigurationBaseEntity() {
	 ...
	 *            otherwise should be null.
	 */
	protected MatchingConfigurationBaseEntity(String type,
	...
	public long getMatchingConfigurationId() {
		return -1;
	}

	public Object getMatchingConfigurationType() {
		return null;
	}
