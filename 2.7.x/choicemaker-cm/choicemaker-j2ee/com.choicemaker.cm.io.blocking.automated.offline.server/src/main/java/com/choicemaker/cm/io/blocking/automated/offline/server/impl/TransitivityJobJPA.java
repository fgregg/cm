 ...
 *
 */
public interface TransitivityJobJPA extends BatchJobJPA {

	/** Hides {@link BatchJobJPA#DISCRIMINATOR_VALUE} */
	String DISCRIMINATOR_VALUE = "TRANSITIVITY";

	/**
	 * Name of the query that finds all persistent transitivity job
	 * instances
	 */
	String QN_TRANSITIVITY_FIND_ALL =
			"transitivityFindAll";
	...
	/** Name of the query that finds all persistent transitivity jobs
	 * that have a given (persistent) batch job as their parent
	 */
	...
	String JPQL_TRANSITIVITY_FIND_ALL_BY_PARENT_ID =
			"Select job from TransitivityJobBean job where job.bparentId = :bparentId";
