...
public class AbaSettingsBean implements AbaSettings {
	...
	public String toString() {
		return "SettingsBean [id=" + id + ", type=" + type + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		AbaSettingsBean other = (AbaSettingsBean) obj;
		if (id != other.id) {
			return false;
		}
