...
public interface DatabaseAccessor {
	...
	/**
	 * Implementations should return a DatabaseAccessor with the
	 * same DataSource and condition Object as this object (the one being
	 * cloned), but with a <code>java.sql.Connection</code> member that
	 * hasn't been opened yet and which is independent of the
	 * <code>Connection</code> held by this object (the one being cloned).
	 * @exception CloneNotSupportException if this object can't be
	 * cloned.
	 */
