...
import com.choicemaker.cm.compiler.backend.Translator25;
 ...
 *
 */
public class CompilationUnit25 extends CompilationUnit {

	/**
	 * @param env
	 * @param source
	 */
	public CompilationUnit25(CompilationEnv env, Sourcecode source) {
		super(env, source);
	}
