...
/**
 * System properties used by offline automated blocking classes:<ul>
 * <li/>Property names begin with <code>PN_</code>
 * <li/>Default property values begin with <code>DPV_</code>
 * </ul>
 * For efficiency, type-safe accessors are provided for non-String
 * property values.
 * @author rphall
...
public class OabaProperties {
	 ...
	 * {@link com.choicemaker.cm.io.blocking.automated.offline.result.MRPSCreator MRPSCreator}
	 * class to dump the record pairs held by its
	 * {@link com.choicemaker.cm.analyzer.sampler.PairSampler Sampler} delegate
	 * between batch computations.
	 * <p>
	 * <strong>Note that record pairs are dumped to an insecure, temporary file.</strong></p>
	 */
	...
	/**
	 * Returns the value of the System propery {@link #PN_RESULT_MRPSCREATOR_DUMP_SAMPLER} as
	 * a primitive boolean.
	 */
	public static boolean isSamplerDumped() {
		// NOTE getBoolean is consistent with the current default value of this property
